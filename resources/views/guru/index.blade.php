            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                    ...
                    <div class="btn-group">
                        <button onclick="addForm('{{ route('guru.store') }}')" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> Tambah Data</button>
                    </div>
...
@push('js')
    <script>
       ...
       function editForm(url) {
        ...
        $.get(url)
            .done((response) => {
                $('#modal-form [name=nama_guru]').val(response.nama_guru);

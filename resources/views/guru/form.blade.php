              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <div class="form-group row">
                          <label for="nama_guru" class="col-md-2 col-md-offset-1 control-label">Nama Guru</label>
                          <div class="col-md 6">
                              <input type="text" name="nama_guru" id="nama_guru" class="form-control" required autofocus>
